...
#Mostrar a lista
    def exibir(self):
        atual = self.inicio
        itens = []
        while atual is not None:                               #Vai percorre até achar Npne
...
#Teste da Exigência 2/7: inserirSemPrioridade (ordem de chegada) ---
    # n1 = Nodo(201, "A")
    # n2 = Nodo(202, "A")
    # n3 = Nodo(1, "V")
    # fila.inserirSemPrioridade(n1)
    # fila.inserirSemPrioridade(n2)
    # fila.inserirSemPrioridade(n3)
    # print("Lista sem prioridade (ordem de chegada):")
    # fila.exibir()
    
#Teste inserindo ordenado
    # fila.inserirOrdenado(1,"V")
    # fila.inserirOrdenado(205,"A")
    # fila.inserirOrdenado(201,"A")
    # fila.inserirOrdenado(2,"V")
    # fila.inserirOrdenado(220,"A")

    # print("Fila atual de pacientes (prioridade correta): ")
    # fila.exibir()

    #situação 1: lista inicia vazia
    #print(">>> situacao 1")
    #fila.inserirComPrioridade(Nodo(300, 'V'))
    #fila.exibir()
   # print("---------------")

    #situação 2: inseria "A" - deve ficar antes dos V, mas após todos os A
   #print(">>> situacao 2")
   # fila.inserirComPrioridade(Nodo(210, 'A'))
   # fila.inserirComPrioridade(Nodo(205, 'A'))
   # fila.exibir()
   # print("---------------")

    #situação 3: outro V no inicio
    #print(">>> situacao 3")
    #fila.inserirComPrioridade(Nodo(10, 'V'))
    #fila.exibir()
    #print("--------------")